...
final class ConnectionBuilderTest extends AbstractConnectionBuilderTest
{
    ...
    {
        $actual = call_user_func([self::getBuilder(), 'connectionFromArray'], $this->letters);
    ...
    {
        $actual = call_user_func([self::getBuilder(), 'connectionFromArray'], $this->letters, ['first' => 2]);
    ...
    {
        $actual = call_user_func([self::getBuilder(), 'connectionFromArray'], $this->letters, ['first' => 10]);
    ...
    {
        $actual = call_user_func([self::getBuilder(), 'connectionFromArray'], $this->letters, ['last' => 2]);
    ...
    {
        $actual = call_user_func([self::getBuilder(), 'connectionFromArray'], $this->letters, ['last' => 10]);
    ...
    {
        $actual = call_user_func(
            [self::getBuilder(), 'connectionFromArraySlice'],
    ...
    {
        $letterCursor = call_user_func([self::getBuilder(), 'cursorForObjectInConnection'], $this->letters, 'B');
    ...
    {
        $letterCursor = call_user_func([self::getBuilder(), 'cursorForObjectInConnection'], $this->letters, 'F');
